...
u = mda.Universe('K62.pdb', 'K62_trajectory.dcd')
...
def main(interval_ns=1):
    ...
    print(f"Analysis complete. Plots saved as 'K62_rmsd_dark_{interval_ns}ns_{timestamp}.png', 'K62_radius_of_gyration_dark_{interval_ns}ns_{timestamp}.png', 'K62_hydrogen_bonds_dark_{interval_ns}ns_{timestamp}.png', and 'K62_rmsf_dark_{timestamp}.png'.")
