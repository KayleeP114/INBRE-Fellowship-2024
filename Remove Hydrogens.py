...
if __name__ == "__main__":
    input_path = os.path.join("/home/inbre/INBRE-Fellowship-2024", input_file)
    output_path = os.path.join("/home/inbre/INBRE-Fellowship-2024", output_file)
